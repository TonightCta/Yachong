...
<template lang="html">
  <div class="strategyList">
    <p class="listTitle">
      策略列表
      <el-button icon="el-icon-plus" type="primary" size="small" @click="addStr=true;">添加策略</el-button>
      <el-tooltip class="item" effect="dark" content="刷新数据" placement="bottom">
        <i class="el-icon-refresh" @click="getStarList()"></i>
      </el-tooltip>
    </p>
    <div class="listCon">
      <el-row>
    ...
    <div class="">
      <el-dialog
        ...
        <div class="">
          ...
          <div class="" style="mineHeight:600px;" v-loading="loadCus">
            <el-row v-for="(buyMes,indexBuy) in buyBackList" :key="indexBuy">
              ...
              <el-col :span="4"><div class="buyMes">
                <span v-if="buyMes.investment_amount!=null&&buyMes.investment_amount!=''">{{buyMes.investment_amount}}</span>
                <span v-else>-</span>
              </div></el-col>
            </el-row>
          </div>
          ...
          <p class="paperBox" v-else>
            <el-pagination
             ...
             :current-page.sync="currentPageCus"
             :page-size="100"
    ...
    <div class="">
      <el-dialog
        ...
        <el-upload
          ...
          drag
          action="http://admin.dahujing.com/api/upload/strategy"
      ...
      <el-dialog
        ...
        <div class="editStrBox">
          ...
          <ul>
            ...
            <li>
              <el-input type="primary" placeholder="请输入标签名称" style="width:200px;" v-model="editMes.tag"></el-input>
      ...
      <el-dialog
        ...
        <div class="editStrBox">
          ...
          <ul>
            ...
            <li>
              <el-input type="primary" placeholder="请输入标签名称" style="width:200px;" v-model="addMes.tag"></el-input>
              <span style="marginLeft:10px">多个标签使用,隔开(<font style="color:red">*英文符下</font>)</span>
            </li>
            <li>
...
export default {
  ...
  methods:{
    ...
    handleCurrentChangeCus(val){
      this.openBug(this.strID)
    },
    openBug(index){//客户详情
      this.strID=index;
      this.loadCus=true;
      // this.buyBackList=this.stList[index].buyList;
      this.$http.getListAPI('account?strategy_id='+this.stList[index].id+'&page='+this.currentPageCus+'&limit=10').then(res=>{
        if(res.data.state==1){
          this.buyBackList=res.data.data.list;
          this.openBuy=true;
    ...
    editStrOpen(index){//编辑策略
      this.$http.getListAPI('strategy/'+this.stList[index].id).then(res=>{
        if(res.data.state==1){
    ...
    subAdd(){//提交新增策略
      if(this.addMes.name==''||this.addMes.name==null){
        ...
        this.btnLoading=true;
        this.$http.postFormAPI('strategy',{
    ...
    getStarList(){//获取策略列表
      this.loadStar=true;
      this.$http.getListAPI('strategy?page='+this.currentPage3+'&limit=15').then(res=>{
        if(res.data.state==1){
          this.loadStar=false;
          this.allPage=(res.data.data.pagination.total/15)*100;;
