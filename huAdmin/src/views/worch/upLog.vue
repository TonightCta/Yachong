  ...
  <div class="upLog">
    <p class="logTitle">净值上传记录
      ...
      <el-tooltip class="item" effect="dark" content="刷新数据" placement="bottom">
        <i class="el-icon-refresh" @click="getLogList()"></i>
      </el-tooltip>
    </p>
    <div style="padding:10px;">
      ...
      <div class="" v-loading="logLoading" style="minHeight:600px;">
    ...
    <div class="">
      <el-dialog
        ...
        <el-upload
          ...
          drag
          name="file"
          action="http://admin.dahujing.com/api/upload/profit"
...
export default {
  ...
  methods:{
    ...
    getLogList(){//获取记录列表
      ...
      this.$http.getListAPI('upload/log?page='+this.currentPage3+'&limit=15').then((res)=>{
        if(res.data.state==1){
          this.logLoading=false;
          this.logPage=(res.data.data.pagination.total/15)*100;
